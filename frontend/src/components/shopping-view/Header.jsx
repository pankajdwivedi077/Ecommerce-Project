...
function MenuItems() {
  ...
  return (
    <nav className="flex flex-col mt-2 lg:mt-0 lg:items-center gap-6 lg:flex-row">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Avatar className="bg-black">
            <AvatarFallback className="bg-black text-white font-extrabold flex items-center justify-center w-full h-full">
